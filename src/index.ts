...
<head>
  ...
  <style>
    *{box-sizing:border-box;margin:0;padding:0}
    ...
    .history-table th.asset-col{background:#f0fdf4;color:#166534}
    .history-table th.liability-col{background:#fef2f2;color:#991b1b}
    ...
    .history-table td.asset-cell{background:#f0fdf4}
    .history-table td.liability-cell{background:#fef2f2}
    .history-table tr:hover td{background:#f3f4f6}
    .history-table tr:hover td.sticky-col{background:#f3f4f6}
    .history-table tr:hover td.asset-cell{background:#dcfce7}
    .history-table tr:hover td.liability-cell{background:#fee2e2}
    @media (max-width: 768px) {
